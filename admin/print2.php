...
$sql ="select * from eventbook where id = '$pid' ";
        ...
        <table class="inventory">
            <thead>
                <tr>
                    ...
                    <th><span >STime</span></th>
                    <th><span >ETime</span></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><span ><?php echo $members; ?></span></td>
                    <td><span ><?php echo $phone; ?> </span></td>
                    <td><span data-prefix></span><span ><?php  echo $meal;?></span></td>
                    <td><span ><?php echo $stime;?> </span></td>
                    <td><span data-prefix></span><span><?php echo $etime; ?></span></td>
                </tr>
